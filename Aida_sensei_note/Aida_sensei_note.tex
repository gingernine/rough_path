...
\chapter{}
	\input{texfiles/p_variation}
	\input{texfiles/proof_of_continuity_theorem}
	%\input{texfiles/Young_integral}
	\input{texfiles/p_rough_path}
...
\chapter{テンソル積・クロスノルム}
	...
	\input{../tensor_space/texfiles/multilinear_mapping}
	\input{../tensor_space/texfiles/completion_of_normed_space}
	\input{../tensor_space/texfiles/tensor_product_multiple}
	\input{../tensor_space/texfiles/crossnorm}
	\input{../tensor_space/texfiles/tensor_product_hilbert}
...
\begin{thebibliography}{数字}
  ...
  \bibitem{key8} E. Cheney and W. Light, Approximation theory of tensor product spaces, Springer, 1985.
  \bibitem{key10} R. Ryan, Introduction to tensor products of Banach spaces, Springer, 2002.
  \bibitem{key9} mathoverFlow, available from https://mathoverflow.net/questions/277070/tensor-product-space-with-projective-norm-is-incomplete, 2018/05/24.
