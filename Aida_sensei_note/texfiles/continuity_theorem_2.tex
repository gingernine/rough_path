\section{2018/06/15 課題}
	...
	\begin{prf}
		...
		\begin{align}
			...
			\quad (|D| \longrightarrow 0)
		\end{align}
		が従う．(\refeq{eq:thm_approximation_of_RS_integral_by_high_order_derivatives_2})を示す．
	...
	\begin{prf}\mbox{}
		\begin{description}
			...
			\item[第二段]
				...
				\end{align}
				を満たす$t_{(0)}$が存在する(補題\ref{lem:control_function_min})．
	...
	\begin{screen}
		(\refeq{eq:thm_continuity_theorem_expansion_2})の証明．
	\end{screen}
