\section{2018/06/15 課題}
	...
	\begin{align}
		...
		&\leq \epsilon M \left\{ 3 + 2 \omega(0,T)^{1/p} \right\} \omega(0,T)^{3/(n+1)} \left\{ \sum_{j=0}^{n-1} \frac{1}{j!} \left[ \omega(0,T)^{1/(n+1)} \right]^j \right\} \left( \frac{2\omega(s,t)}{N-k-1} \right)^{(n+1)/p} \\
			&\quad + \epsilon M 2 \omega(0,T)^{2/(n+1)} \left\{ \sum_{j=1}^{n-1} \frac{1}{(j-1)!} 2^{j-1} \left[ \omega(0,T)^{1/(n+1)} \right]^{j-1} \right\} \left( \frac{2\omega(s,t)}{N-k-1} \right)^{(n+1)/p} \\
			&\quad + \epsilon M \left\{ 1 + \omega(0,T)^{1/p} \right\} \omega(0,T)^{1/(n+1)} \left\{ \sum_{j=0}^{n-1} \frac{1}{j!} 2^j \left[ \omega(0,T)^{1/(n+1)} \right]^j \right\} \left( \frac{2\omega(s,t)}{N-k-1} \right)^{(n+1)/p} \\
		&\leq \epsilon M \left[ \left\{ 3 + 2 \omega(0,T)^{1/p} \right\} \omega(0,T)^{3/(n+1)} e^{\omega(0,T)^{1/(n+1)}}
			...
			&\quad + \left. \left\{ 1 + \omega(0,T)^{1/p} \right\} \omega(0,T)^{1/(n+1)} e^{2 \omega(0,T)^{1/(n+1)}} \right] \left( \frac{2\omega(s,t)}{N-k-1} \right)^{(n+1)/p}
	\end{align}
	となる．一方で
	\begin{align}
